...
test("seventh mixed text review is hash-only and fully applied", () => {
    ...
    assert.deepEqual(missingRows, [
        ...
        { file: "16c-royart3-cos2-part02.ps1", row: 18 },
    ]);
});
...
test("eleventh mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER11_PATH, {
        ...
        expectedMissingRows: [
            ...
            { file: "16c-glue-19-int-glue.ps1", row: 26 },
...
test("twenty-ninth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER29_PATH, {
        ...
        expectedSupersededRows: [
            { file: "16c-serial05-mp-sc.ps1", row: 22 },
...
test("thirty-seventh mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER37_PATH, {
        ...
        expectedMissingRows: [],
        expectedSupersededRows: [
            { file: "16c-fog03-if-dd-part01.ps1", row: 2 },
        ],
    });
});
...
test("fiftieth mixed text review is hash-only and fully applied", () => {
...
test("fifty-second mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER52_PATH, {
        candidateFiles: 34,
        evidenceRows: 55,
        expectedMissingRows: [],
    });
...
test("fifty-third mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER53_PATH, {
        candidateFiles: 13,
        evidenceRows: 17,
        expectedMissingRows: [],
    });
...
test("fifty-fourth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER54_PATH, {
        candidateFiles: 55,
        evidenceRows: 85,
        expectedMissingRows: [
            { file: "16c-d0pe0597-lac-uk.ps1", row: 25 },
            { file: "16c-glue-19-int-glue.ps1", row: 27 },
            { file: "16c-serial05-mp-sc.ps1", row: 23 },
        ],
    });
});

test("fifty-fifth mixed text review is hash-only and fully applied", () => {
...
test("fifty-sixth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER56_PATH, {
        candidateFiles: 8,
        evidenceRows: 18,
        expectedMissingRows: [
            { file: "16c-acdu1093-fn-bs1.ps1", row: 51 },
            { file: "16c-aeon0196-logon5.ps1", row: 40 },
            { file: "16c-royart3-csoc-part02.ps1", row: 39 },
        ],
    });
});

test("fifty-seventh mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER57_PATH, {
        candidateFiles: 12,
        evidenceRows: 46,
        expectedMissingRows: [],
    });
...
test("fifty-eighth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER58_PATH, {
        candidateFiles: 7,
        evidenceRows: 9,
        expectedMissingRows: [],
    });
...
test("fifty-ninth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER59_PATH, {
        candidateFiles: 3,
        evidenceRows: 4,
        expectedMissingRows: [],
    });
...
test("sixtieth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER60_PATH, {
        candidateFiles: 27,
        evidenceRows: 79,
        expectedMissingRows: [
            { file: "16c-riot-019-pm-wrlk.ps1", row: 20 },
            { file: "16c-riot0598-pm-bbl.ps1", row: 24 },
            { file: "16c-spas9503-im-tsn-part03.ps1", row: 35 },
        ],
    });
});

test("sixty-first mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER61_PATH, {
        candidateFiles: 7,
        evidenceRows: 22,
        expectedMissingRows: [],
    });
...
test("sixty-second mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER62_PATH, {
        candidateFiles: 7,
        evidenceRows: 16,
        expectedMissingRows: [],
    });
...
test("sixty-third mixed text review is hash-only and fully applied", () => {
...
test("sixty-sixth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER66_PATH, {
        candidateFiles: 47,
        evidenceRows: 63,
        expectedMissingRows: [],
    });
...
test("sixty-seventh mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER67_PATH, {
        candidateFiles: 23,
        evidenceRows: 31,
        expectedMissingRows: [],
    });
...
test("sixty-eighth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER68_PATH, {
        candidateFiles: 16,
        evidenceRows: 19,
        expectedMissingRows: [],
    });
...
test("sixty-ninth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER69_PATH, {
        candidateFiles: 2,
        evidenceRows: 4,
        expectedMissingRows: [],
    });
...
test("seventieth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER70_PATH, {
        candidateFiles: 10,
        evidenceRows: 21,
        expectedMissingRows: [],
    });
...
test("seventy-first mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER71_PATH, {
        candidateFiles: 2,
        evidenceRows: 8,
        expectedMissingRows: [],
    });
...
test("seventy-second mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER72_PATH, {
        candidateFiles: 28,
        evidenceRows: 41,
        expectedMissingRows: [],
    });
...
test("seventy-third mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER73_PATH, {
        candidateFiles: 6,
        evidenceRows: 17,
        expectedMissingRows: [],
    });
...
test("seventy-fourth mixed text review is hash-only and fully applied", () => {
...
test("seventy-fifth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER75_PATH, {
        candidateFiles: 2,
        evidenceRows: 3,
        expectedMissingRows: [],
    });
...
test("seventy-sixth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER76_PATH, {
        candidateFiles: 9,
        evidenceRows: 24,
        expectedMissingRows: [
            { file: "16c-epic0001-may-obs.ps1", row: 26 },
            { file: "16c-epic0001-may-obs.ps1", row: 27 },
        ],
    });
});

test("seventy-seventh mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER77_PATH, {
        candidateFiles: 10,
        evidenceRows: 19,
        expectedMissingRows: [],
    });
...
test("seventy-eighth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER78_PATH, {
        candidateFiles: 14,
        evidenceRows: 17,
        expectedMissingRows: [
            { file: "16c-eden1294-bs-eden2-part03.ps1", row: 42 },
            { file: "16c-ice9607a-th-rust.ps1", row: 28 },
            { file: "16c-tlyx-02-om-deh.ps1", row: 28 },
            { file: "16c-twat0898-lgc-twt.ps1", row: 24 },
...
test("eightieth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER80_PATH, {
        candidateFiles: 2,
        evidenceRows: 7,
        expectedMissingRows: [],
    });
...
test("eighty-first mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER81_PATH, {
        candidateFiles: 7,
        evidenceRows: 18,
        expectedMissingRows: [],
    });
...
test("eighty-second mixed text review is hash-only and fully applied", () => {
...
test("eighty-third mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER83_PATH, {
        candidateFiles: 1,
        evidenceRows: 1,
        expectedMissingRows: [],
    });
...
test("eighty-fourth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER84_PATH, {
        candidateFiles: 1,
        evidenceRows: 2,
        expectedMissingRows: [],
    });
...
test("eighty-fifth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER85_PATH, {
        candidateFiles: 1,
        evidenceRows: 1,
        expectedMissingRows: [],
    });
...
test("eighty-sixth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER86_PATH, {
        candidateFiles: 1,
        evidenceRows: 5,
        expectedMissingRows: [],
    });
...
test("eighty-seventh mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER87_PATH, {
        candidateFiles: 2,
        evidenceRows: 8,
        expectedMissingRows: [],
    });
...
test("eighty-eighth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER88_PATH, {
        candidateFiles: 1,
        evidenceRows: 5,
        expectedMissingRows: [],
    });
...
test("eighty-ninth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER89_PATH, {
        candidateFiles: 1,
        evidenceRows: 2,
        expectedMissingRows: [],
    });
...
test("ninetieth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER90_PATH, {
        candidateFiles: 1,
        evidenceRows: 2,
        expectedMissingRows: [],
    });
...
test("ninety-first mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER91_PATH, {
        candidateFiles: 1,
        evidenceRows: 4,
        expectedMissingRows: [],
    });
...
test("ninety-second mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER92_PATH, {
        candidateFiles: 1,
        evidenceRows: 11,
        expectedMissingRows: [],
    });
...
test("ninety-third mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER93_PATH, {
        candidateFiles: 3,
        evidenceRows: 4,
        expectedMissingRows: [],
    });
...
test("ninety-fourth mixed text review is hash-only and fully applied", () => {
    assertAppliedMixedTextLedger(MIXED_TEXT_LEDGER94_PATH, {
        candidateFiles: 8,
        evidenceRows: 9,
        expectedMissingRows: [],
    });
