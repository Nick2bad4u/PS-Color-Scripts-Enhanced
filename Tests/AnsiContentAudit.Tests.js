...
test("content curation checkpoint matches the retained gallery state", () => {
    ...
    assert.equal(checkpoint.contentCleanup.totalRowsBlanked, 47013);
    assert.equal(checkpoint.contentCleanup.totalTrailingRowsRemoved, 23860);
    assert.equal(
    ...
    assert.equal(checkpoint.contentCleanup.residualMixedTextRowsBlanked, 13053);
    assert.equal(
