...
test("content curation checkpoint matches the retained gallery state", () => {
    ...
    assert.equal(checkpoint.contentCleanup.totalRowsBlanked, 49707);
    assert.equal(checkpoint.contentCleanup.totalTrailingRowsRemoved, 23956);
    assert.equal(
    ...
    assert.equal(checkpoint.contentCleanup.residualMixedTextRowsBlanked, 15747);
    assert.equal(
