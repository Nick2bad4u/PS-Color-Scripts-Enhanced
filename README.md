...
1. [Features](#features)
2. [Demo](#demo)
3. [Open in new tab since video is too large for github](#open-in-new-tab-since-video-is-too-large-for-github)
4. [+ <!-- COLOR_SCRIPT_COUNT_MINUS_IMAGES -->495<!-- /COLOR_SCRIPT_COUNT_MINUS_IMAGES --> more colorscripts available](#----color_script_count_minus_images---495---color_script_count_minus_images----more-colorscripts-available)
5. [Quick Start (Less Than a Minute)](#quick-start-less-than-a-minute)
6. [PowerShell Support](#powershell-support)
7. [Internationalization](#internationalization)
8. [Install a Nerd Font for Custom Glyphs](#install-a-nerd-font-for-custom-glyphs)
...
20. [Available Colorscripts](#available-colorscripts)
21. [Troubleshooting](#troubleshooting)
22. [Requirements](#requirements)
23. [Architecture](#architecture)
24. [Contributing (2)](#contributing-2)
25. [License](#license)
26. [Version History](#version-history)
27. [Documentation (2)](#documentation-2)
28. [CI/CD & Workflows](#cicd--workflows)
29. [Testing](#testing)
30. [Support](#support)
31. [ANSI art sourced from](#ansi-art-sourced-from)
