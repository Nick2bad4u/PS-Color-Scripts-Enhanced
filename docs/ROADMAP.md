...
- <!-- COLOR_SCRIPT_COUNT -->9781<!-- /COLOR_SCRIPT_COUNT --> bundled colorscripts with metadata-backed discovery
...
- Complete the 1990-2000 16colors review, then periodically refresh the completed 2001-2026 and Roy checkpoints.
