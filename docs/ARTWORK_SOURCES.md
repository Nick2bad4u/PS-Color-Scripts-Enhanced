...
- Review status: 2004-2026 review-complete, with every accepted work imported; 1990-2003 still in progress
...
The 2004-2026 review is complete and its accepted works are in the module. Across those 23 archive years, the audit covered 565 packs and 10,051 `.ANS` or `.ICE` candidates, accepted 2,382 works, and emitted 5,260 scripts after exact row or panel splitting. The latest completed tranche contributed 47 works as 119 scripts from 2004, 45 works as 124 scripts from 2005, 16 works as 16 scripts from 2006, and 23 works as 23 scripts from 2007. The checked-in compact checkpoint records each year's inventory fingerprint, disposition totals, and accepted source/hash list.

The older archive is not complete. Subtracting the 1,270 candidates now reviewed for 2004-2007 from the previous estimate leaves approximately 37,973 candidates across 14 years from 1990 through 2003. That total is explicitly an estimate, not a permanent inventory count: archive refreshes, API corrections, and normalized duplicate detection can change it.
