...
The 1998-2026 review is complete and its accepted works are in the module. Across those 29 archive years, the audit covered 2,212 packs and 23,569 `.ANS` or `.ICE` candidates, accepted 5,788 works, and emitted 9,059 scripts after exact row or panel splitting. The latest completed tranches contributed 2,114 works as 2,417 scripts from 1998 and 1999. The checked-in compact checkpoint records each year's inventory fingerprint, disposition totals, and accepted source/hash list.

The older archive is not complete. Subtracting the 8,946 candidates now reviewed for 1998 and 1999 from the previous estimate leaves approximately 24,455 candidates across eight years from 1990 through 1997. That total is explicitly an estimate, not a permanent inventory count: archive refreshes, API corrections, and normalized duplicate detection can change it.
