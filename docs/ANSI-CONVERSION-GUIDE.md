...
| [16colors](https://16colo.rs/)                                              | 5,479 enumerated packs and 64,929 `.ANS` or `.ICE` candidates reviewed for 1990-2026 | Project-specific artist/rightsholder permission with attribution | 15,244 accepted works emitted as 21,794 scripts; every archive year has a checked-in inventory fingerprint and disposition total. |
