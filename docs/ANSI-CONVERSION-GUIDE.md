...
| [16colors](https://16colo.rs/)                                              | 2,212 packs and 23,569 candidates reviewed for 1998-2026; 3,267 packs and 41,360 candidates inventoried for the in-progress 1990-1997 review | Project-specific artist/rightsholder permission with attribution | 5,782 accepted works emitted as 9,046 scripts from the completed years; earlier-year selection and splitting remain in progress. |
