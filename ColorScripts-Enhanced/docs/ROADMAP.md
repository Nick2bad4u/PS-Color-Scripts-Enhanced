...
- <!-- COLOR_SCRIPT_COUNT -->9447<!-- /COLOR_SCRIPT_COUNT --> bundled colorscripts with metadata-backed discovery
...
- Complete the 1990-2001 16colors review, then periodically refresh the completed 2002-2026 and Roy checkpoints.
