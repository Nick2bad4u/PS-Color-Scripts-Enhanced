...
- <!-- COLOR_SCRIPT_COUNT -->8792<!-- /COLOR_SCRIPT_COUNT --> bundled colorscripts with metadata-backed discovery
...
- Complete the 1990-2003 16colors review, then periodically refresh the completed 2004-2026 and Roy checkpoints.
