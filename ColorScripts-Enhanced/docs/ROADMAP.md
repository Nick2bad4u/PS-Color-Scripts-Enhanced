...
- <!-- COLOR_SCRIPT_COUNT -->8974<!-- /COLOR_SCRIPT_COUNT --> bundled colorscripts with metadata-backed discovery
...
- Complete the 1990-2002 16colors review, then periodically refresh the completed 2003-2026 and Roy checkpoints.
