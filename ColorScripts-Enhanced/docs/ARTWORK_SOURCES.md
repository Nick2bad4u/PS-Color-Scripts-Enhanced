...
- Review status: 2002-2026 review-complete, with every accepted work imported; 1990-2001 still in progress
...
The 2002-2026 review is complete and its accepted works are in the module. Across those 25 archive years, the audit covered 857 packs and 12,078 `.ANS` or `.ICE` candidates, accepted 3,013 works, and emitted 5,915 scripts after exact row or panel splitting. The latest completed tranche contributed 449 works as 473 scripts from 2002. The checked-in compact checkpoint records each year's inventory fingerprint, disposition totals, and accepted source/hash list.

The older archive is not complete. Subtracting the 1,285 candidates now reviewed for 2002 from the previous estimate leaves approximately 35,946 candidates across 12 years from 1990 through 2001. That total is explicitly an estimate, not a permanent inventory count: archive refreshes, API corrections, and normalized duplicate detection can change it.
