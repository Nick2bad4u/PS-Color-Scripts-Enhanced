...
- Recent hash-locked mixed-text evidence: [eightieth mixed-text review](../AnsiResidualMixedTextReviewLedger80.json), [eighty-first mixed-text review](../AnsiResidualMixedTextReviewLedger81.json), and [eighty-second mixed-text review](../AnsiResidualMixedTextReviewLedger82.json)
