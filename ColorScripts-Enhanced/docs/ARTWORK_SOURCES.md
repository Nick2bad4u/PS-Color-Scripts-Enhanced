...
- Review status: 2008-2026 review-complete, with every accepted work imported; 1990-2007 still in progress
...
The 2008-2026 review is complete and its accepted works are in the module. Across those 19 archive years, the audit covered 393 packs and 8,781 `.ANS` or `.ICE` candidates, accepted 2,252 works, and emitted 4,979 scripts after exact row or panel splitting. The latest completed tranche contributed 62 works as 138 scripts from 2008, 34 works as 98 scripts from 2009, 7 works as 10 scripts from 2010, and no qualifying works from the three 2011 candidates. Earlier completed tranches contributed 11 works as 16 scripts from 2012, 50 works as 147 scripts from 2013, 93 works as 318 scripts from 2014, 67 works as 220 scripts from 2015, and 71 works as 184 scripts from 2016. The checked-in compact checkpoint records each year's inventory fingerprint, disposition totals, and accepted source/hash list.
