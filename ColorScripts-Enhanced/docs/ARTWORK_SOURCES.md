...
- Recent hash-locked mixed-text evidence: [eighty-second mixed-text review](../AnsiResidualMixedTextReviewLedger82.json), [eighty-third mixed-text review](../AnsiResidualMixedTextReviewLedger83.json), [eighty-fourth mixed-text review](../AnsiResidualMixedTextReviewLedger84.json), and [eighty-fifth mixed-text review](../AnsiResidualMixedTextReviewLedger85.json)
