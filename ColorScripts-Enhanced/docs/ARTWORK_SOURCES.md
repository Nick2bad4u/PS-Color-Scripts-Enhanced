...
- Recent hash-locked mixed-text evidence: [eighty-first mixed-text review](../AnsiResidualMixedTextReviewLedger81.json), [eighty-second mixed-text review](../AnsiResidualMixedTextReviewLedger82.json), and [eighty-third mixed-text review](../AnsiResidualMixedTextReviewLedger83.json)
