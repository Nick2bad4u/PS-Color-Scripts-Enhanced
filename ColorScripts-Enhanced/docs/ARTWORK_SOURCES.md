...
- Recent hash-locked mixed-text evidence: [nineteenth mixed-text review](../AnsiResidualMixedTextReviewLedger19.json) and [twentieth mixed-text review](../AnsiResidualMixedTextReviewLedger20.json)
