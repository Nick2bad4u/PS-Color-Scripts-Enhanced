...
- Recent hash-locked mixed-text evidence: [seventy-eighth mixed-text review](../AnsiResidualMixedTextReviewLedger78.json), [seventy-ninth mixed-text review](../AnsiResidualMixedTextReviewLedger79.json), and [eightieth mixed-text review](../AnsiResidualMixedTextReviewLedger80.json)
