...
- Recent hash-locked mixed-text evidence: [thirtieth mixed-text review](../AnsiResidualMixedTextReviewLedger30.json), [thirty-first mixed-text review](../AnsiResidualMixedTextReviewLedger31.json), and [thirty-second mixed-text review](../AnsiResidualMixedTextReviewLedger32.json)
