...
- Recent hash-locked mixed-text evidence: [sixtieth mixed-text review](../AnsiResidualMixedTextReviewLedger60.json), [sixty-first mixed-text review](../AnsiResidualMixedTextReviewLedger61.json), and [sixty-second mixed-text review](../AnsiResidualMixedTextReviewLedger62.json)
