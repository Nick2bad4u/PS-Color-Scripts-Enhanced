...
- Recent hash-locked mixed-text evidence: [forty-first mixed-text review](../AnsiResidualMixedTextReviewLedger41.json), [forty-second mixed-text review](../AnsiResidualMixedTextReviewLedger42.json), and [forty-third mixed-text review](../AnsiResidualMixedTextReviewLedger43.json)
