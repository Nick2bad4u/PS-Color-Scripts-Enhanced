...
- Recent hash-locked mixed-text evidence: [twenty-first mixed-text review](../AnsiResidualMixedTextReviewLedger21.json) and [twenty-second mixed-text review](../AnsiResidualMixedTextReviewLedger22.json)
