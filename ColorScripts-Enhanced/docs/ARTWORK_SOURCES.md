...
- Recent hash-locked mixed-text evidence: [twentieth mixed-text review](../AnsiResidualMixedTextReviewLedger20.json) and [twenty-first mixed-text review](../AnsiResidualMixedTextReviewLedger21.json)
