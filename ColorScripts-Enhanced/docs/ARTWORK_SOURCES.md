...
- Review status: 2003-2026 review-complete, with every accepted work imported; 1990-2002 still in progress
...
The 2003-2026 review is complete and its accepted works are in the module. Across those 24 archive years, the audit covered 688 packs and 10,793 `.ANS` or `.ICE` candidates, accepted 2,564 works, and emitted 5,442 scripts after exact row or panel splitting. The latest completed tranche contributed 182 works as 182 scripts from 2003; every accepted work fit the 120-by-50 gallery limits without splitting. The checked-in compact checkpoint records each year's inventory fingerprint, disposition totals, and accepted source/hash list.

The older archive is not complete. Subtracting the 742 candidates now reviewed for 2003 from the previous estimate leaves approximately 37,231 candidates across 13 years from 1990 through 2002. That total is explicitly an estimate, not a permanent inventory count: archive refreshes, API corrections, and normalized duplicate detection can change it.
