...
- Recent hash-locked mixed-text evidence: [forty-second mixed-text review](../AnsiResidualMixedTextReviewLedger42.json), [forty-third mixed-text review](../AnsiResidualMixedTextReviewLedger43.json), and [forty-fourth mixed-text review](../AnsiResidualMixedTextReviewLedger44.json)
