...
- Recent hash-locked mixed-text evidence: [fortieth mixed-text review](../AnsiResidualMixedTextReviewLedger40.json), [forty-first mixed-text review](../AnsiResidualMixedTextReviewLedger41.json), and [forty-second mixed-text review](../AnsiResidualMixedTextReviewLedger42.json)
