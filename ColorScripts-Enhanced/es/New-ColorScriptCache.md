...
Modificador de compatibilidad obsoleto. Se acepta silenciosamente sin efecto durante una versión porque los scripts de Pokémon siguen las mismas reglas de `CachePolicy.psd1` que los demás scripts.
