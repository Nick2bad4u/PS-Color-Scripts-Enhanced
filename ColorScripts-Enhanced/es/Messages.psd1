...
FailedToParseConfigurationFile = 'Error al analizar el archivo de configuración en '
UnableToResolveCachePath = 'No se pudo resolver la ruta de caché '
ConfiguredCachePathInvalid = 'La ruta de caché configurada '
UnableToResolveOutputPath = 'No se pudo resolver la ruta de salida '
...
UnableToResolveProfilePath = 'No se pudo resolver la ruta del perfil '
