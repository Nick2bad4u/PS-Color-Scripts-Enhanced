...
FailedToParseConfigurationFile = 'Falha ao analisar o arquivo de configuração em '
UnableToResolveCachePath = 'Não foi possível resolver o caminho do cache '
ConfiguredCachePathInvalid = 'Caminho de cache configurado '
UnableToResolveOutputPath = 'Não foi possível resolver o caminho de saída '
...
UnableToResolveProfilePath = 'Não foi possível resolver o caminho do perfil '
