...
FailedToParseConfigurationFile = '設定ファイルの解析に失敗しました: '
UnableToResolveCachePath = 'キャッシュパスの解決ができませんでした '
ConfiguredCachePathInvalid = '設定されたキャッシュパスが無効です '
UnableToResolveOutputPath = '出力パスの解決ができませんでした '
...
UnableToResolveProfilePath = 'プロファイルパスの解決ができませんでした '
