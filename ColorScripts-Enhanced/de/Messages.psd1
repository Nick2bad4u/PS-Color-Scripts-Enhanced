...
FailedToParseConfigurationFile = 'Konfigurationsdatei konnte nicht analysiert werden unter '
UnableToResolveCachePath = 'Cache-Pfad konnte nicht aufgelöst werden '
ConfiguredCachePathInvalid = 'Konfigurierter Cache-Pfad '
UnableToResolveOutputPath = 'Ausgabepfad konnte nicht aufgelöst werden '
...
UnableToResolveProfilePath = 'Profilpfad konnte nicht aufgelöst werden '
